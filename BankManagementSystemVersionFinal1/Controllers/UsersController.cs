...
namespace BankManagementSystemVersionFinal1.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("LoginId,Name,Password,ConfirmPassword,Email")] User user)
        {
            if (ModelState.IsValid)
            {
                _context.Add(user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LoginId,Name,Password,ConfirmPassword,Email")] User user)
        {
            if (id != user.LoginId)
            {
                return NotFound();
        ...
        {
          return (_context.Users?.Any(e => e.LoginId == id)).GetValueOrDefault();
        }
    }
}
